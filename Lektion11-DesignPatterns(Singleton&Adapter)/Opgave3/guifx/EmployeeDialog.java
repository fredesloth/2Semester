    ...
    private void okAction()
    {
        ...
        if (employee != null) {
            ...
            if (companyIsSelected) {
                Controller.updateCompanyOfEmployee(employee, newCompany);
            }
            else {
                Controller.clearCompanyOfEmployee(employee);
            }
        }
        else {
            Employee newEmployee = Controller.createEmployee(name, wage);
            if (companyIsSelected) {
                Controller.setCompanyOfEmployee(newEmployee, newCompany);
            }
        }
